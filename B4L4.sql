...
select $1 from @ZENAS_ATHLEISURE_DB.PRODUCTS.UNI_KLAUS_CLOTHING;
...
--start string after 54 characters, which is after the final /. its all the same directory, so always 54. 50 is length (unnecessary?)
